...
export default {
  ...
  methods: {
    getInfo (page) {
      if (page) {
        this.$axios.get(url + '/getAll?page=' + page)
          .then(res => { console.log(res); this.tableData = res.data.data; this.total = res.data.count.count })
    ...
    showEdit (data) {
      ...
      console.log(data)
      delete this.editUserForm._index
      delete this.editUserForm._rowKey
